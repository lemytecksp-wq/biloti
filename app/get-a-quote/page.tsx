...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setErrorMessage(
        'We could not send your message. Please try again or call 021 745 179 directly.'
      );
    } finally {
      setLoading(false);
    }
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Whether you need residential water blasting, commercial
                office cleaning, pest treatments, or routine garden
                maintenance, our Auckland team is ready to assist.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-xs flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    Servicing Central, North, West, South, East Auckland,
                    Rodney &amp; Franklin.
                  </p>
                </div>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-xs flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    Direct phone line for bookings and quick enquiries.
                  </p>
                </div>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-xs flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    Send us project details or request quote information.
                  </p>
                </div>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-xs flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    After-hours commercial cleaning available upon arrangement.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-xs bg-slate-900 text-white p-6 relative">
              <div className="space-y-2 relative z-10">
                ...
                <h4 className="font-bold text-lg text-white">
                  Servicing Greater Auckland
                </h4>

                <p className="text-xs text-slate-300">
                  From Albany down to Papakura, Titirangi across to Howick.
                  We bring complete property care equipment directly to your
                  site.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 sm:p-10 rounded-2xl border border-slate-200 shadow-md space-y-6">
              ...
              >
                ...
                <div className="flex items-start gap-3 pt-2">
                  ...
                  >
                    By submitting this form, you acknowledge that you agree
                    to our{' '}

                    <Link
                      href="/privacy-policy"
                      className="text-[#1F6F50] font-semibold underline"
                    >
                      Privacy Policy
                    </Link>{' '}
